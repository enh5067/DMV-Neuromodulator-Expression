...
library(glmGamPoi)
library(readbitmap)
setwd("/Data/Spatial_Transcriptomics")

#Figure 1
brain.merge<-readRDS("FINAL_VISIUM_S0.rds")
...
#Figure 4G
setwd("/Data/IF_quantification/Figure 4")
...
#Figure 7
setwd("Data/IF_quantification/Figure 7/Left_Right")
